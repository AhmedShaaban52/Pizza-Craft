...
export type ProductWithCategory = Product & { category: { name: string } | null };
...
export function getProductFields(categories: Category[]): ModalField[] {
    return [
        ...
        { name: "image", label: "Image URL", type: "file", colSpan: 2 },
        { name: "thumbnails", label: "Thumbnails (comma-separated URLs)", type: "files", colSpan: 2 },
