...
export type WishlistItem = Awaited<ReturnType<typeof getFavorites>>["data"] extends infer D ? (D extends Array<infer I> ? I : never) : never;
...
export default function WishlistClient({ items }: { items: WishlistItem[] }) {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground px-6 py-10 max-w-5xl mx-auto">
